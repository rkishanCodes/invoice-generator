    ...
    return (
        <section className="flex flex-col gap-3">
            ...
            <FormInput
                ...
                placeholder="Hercules Fitness name"
            />
            <FormInput
                name="sender.address"
                label={_t("form.steps.fromAndTo.address")}
                placeholder="Hercules Fitness address"
            />
            <FormInput
                name="sender.zipCode"
                label={_t("form.steps.fromAndTo.zipCode")}
                placeholder="Hercules Fitness zip code"
            />
            <FormInput
                name="sender.city"
                label={_t("form.steps.fromAndTo.city")}
                placeholder="Hercules Fitness city"
            />
            {/* <FormInput
                name="sender.country"
                label={_t("form.steps.fromAndTo.country")}
                placeholder="Hercules Fitness country"
            /> */}
            <FormInput
                name="sender.email"
                label={_t("form.steps.fromAndTo.email")}
                placeholder="Hercules Fitness email"
            />
            <FormInput
                name="sender.phone"
                label={_t("form.steps.fromAndTo.phone")}
                placeholder="Hercules Fitness phone number"
                type="text"
                inputMode="tel"
                pattern="[0-9+\-\(\)\s]*"
